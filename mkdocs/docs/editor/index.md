...
The currently active **Project**'s **Asset Manager**. Each tab along the top are the major asset types handled independantly from each other. All the details are provided in the [Asset Manager](asset-manager.md) section.
